...
const services = [
    {
        id: 1,
        logo: '../assets/images/emergency.png',
    ...
    {
        id: 3,
        logo: '../assets/images/fire-service.png',
    ...
    {
        id: 4,
        logo: '../assets/images/ambulance.png',
    ...
    {
        id: 9,
        logo: '../assets/images/Bangladesh-Railway.png',
...
const serviceTitle = event.target.parentNode.parentNode.children[1].innerText;
 ...
 // Call Function
    if (event.target.className.includes('call_btn')) {
        if (totalCoin <= 0) {
            return alert('Your coin is low, need Minimum 20 coin for call!')
        }
        // Get time 
        let now = new Date();
